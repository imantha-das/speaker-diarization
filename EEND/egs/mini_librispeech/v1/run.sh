...
eval `python3 ../../../eend/bin/yaml2bash.py --prefix train $train_config`
eval `python3 ../../../eend/bin/yaml2bash.py --prefix infer $infer_config`
...
if [ $stage -le 1 ]; then
    ...
    work=$model_dir/.work
    mkdir -p $work
	echo "$train_cmd $work/train.log python3 ../../../eend/bin/train.py -c $train_config $train_args $train_set $valid_set $model_dir"
    $train_cmd $work/train.log \
        python3 ../../../eend/bin/train.py \
            -c $train_config \
            $train_args \
